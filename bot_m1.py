"""
Twitter/X Bot - Mac M1 Version (3 Parallel Windows)

This bot uses multiple cookie files and posts 3 parallel tweets in an infinite loop.
For Mac M1 - optimized for 3 browser windows.
"""
...
async def infinite_posting_loop():
    print(f"🚀 Starting M1 Bot - {WINDOWS_COUNT} parallel windows, infinite loop")
