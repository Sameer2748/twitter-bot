"""
Twitter/X Bot - Mac M2 Version (5 Parallel Windows)

This bot uses multiple cookie files and posts 5 parallel tweets in an infinite loop.
For Mac M2 - optimized for 5 browser windows.
"""
...
async def infinite_posting_loop():
    print(f"🚀 Starting M2 Bot - {WINDOWS_COUNT} parallel windows, infinite loop")
